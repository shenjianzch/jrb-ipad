  ...
  function fastclickClient() {
	...
	FastClick.prototype.onTouchStart = function(event) {
		...
		var targetElement, touch, selection, touchStartTime = Date.now();
	...
	FastClick.prototype.onTouchEnd = function(event) {
		var forElement, trackingClickStart, targetTagName, scrollParent, touch, touchEndTime = Date.now(),
      targetElement = this.targetElement;
      const targetClass = event.target.className.split(' ');
    // console.log(targetClass, 'targetClasstargetClasstargetClasstargetClass');
    if (
      targetClass.indexOf('ctouch') !== -1 ||
      targetClass.indexOf('el-upload') !== -1 ||
      targetClass.indexOf('el-icon-close') !== -1
    ) {
      return false;
    }
...
export default fastclickClient;